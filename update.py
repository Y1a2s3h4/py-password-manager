...
def update_credentials(name):
    ...
    findPass = tk.Label(window, text="Find Password:  ",bg="#45aaf2", fg="#fff", font=("Poppins", 16, "normal")).grid(row=1, column=0,sticky="W", padx=10, pady=(10,0))

    findPassInput = tk.Entry(window, width=30, font=("Poppins", 16))
    findPassInput.grid(row=2, column=0,sticky="W", padx=10, pady=10)

    titleLabel = tk.Label(window, text="Enter Your Password For: ",bg="#45aaf2", fg="#fff", font=("Poppins", 16, "normal")).grid(row=4, column=0,sticky="W", padx=10, pady=(10,0))

    titleInput = tk.Entry(window, width=30, font=("Poppins", 16))
    titleInput.grid(row=5, column=0,sticky="W", padx=10, pady=10)

    userLabel = tk.Label(window, text="Enter Your Username: ",bg="#45aaf2", fg="#fff", font=("Poppins", 16, "normal")).grid(row=7, column=0,sticky="W", padx=10, pady=(10,0))

    userInput = tk.Entry(window, width=30, font=("Poppins", 16))
    userInput.grid(row=8, column=0,sticky="W", padx=10, pady=10)
    ...
    btnSubmit = tk.Button(window, text = "Update", command = updateData, width=10, font=("Poppins", 16)).grid(row=12,sticky="W" ,column = 0,padx=10,pady=10)
    ShowData = tk.Button(window, text = "Show Data", command = show, width=10, font=("Poppins", 16)).grid(row=12,sticky="W" ,column = 0, padx=(200,0), pady=10, ipadx=20)
