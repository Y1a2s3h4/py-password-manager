...
window = tk.Tk()
window.title("Password Manager Login Form")
...
labPassLogin = tk.Label(window, text="PASSWORD",bg="#45aaf2", fg="#fff",font=("Arial", 20, "bold")).grid(row=6, column=0,sticky="W", padx=160, pady=(45,0))
...
btnSubmit = tk.Button(window, text = "L o g i n",width= 15, command = login,bg="white", font=("Poppins", 15,"normal")).grid(row=13, column = 0,padx=10, pady=(70,0))
